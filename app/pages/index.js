        ...
        {articles.map((article) => (
          ...
          >
            <a href={`/articles/${article.id}`}>
              <article className="group duration-200 relative text-left cursor-pointer transform transition-transform ease-in-out hover:scale-110 shadow-xl shadow-transparent hover:shadow-white/10 z-10">
                <div
                  style={{
                    position: "relative",
                    height: "180px", 
